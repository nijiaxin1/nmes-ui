<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="planFinishList"
      ...
      <el-table-column label="姓名" align="center" prop="planOperateBy" fixed="left" />
      <el-table-column label="班组" align="center" prop="planWorkTeam"  fixed="left"/>
      <el-table-column label="班次" align="center" prop="planWorkScheduleClass"  fixed="left"/>
      <el-table-column label="物料" align="center" prop="itemCode" fixed="left" />
...
import { listPlanFinish } from "@/api/sheet/planFinishRecords";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.loading = true;
      listPlanFinish(this.queryParams).then(response => {
